...
public class ChannelScanProgram implements Serializable
{
    ...
    //important tags
    public static final String TAG_DRM = "drm";
    ...
    public ChannelScanProgram( String aProgramString, int aProgramNumber, int aVirtualMajor, int aVirtualMinor, String aType, String aName )
    {
    ...
    public ChannelScanProgram( String aProgramString, int aProgramNumber, int aVirtualMajor, int aVirtualMinor, String aType, String aName, boolean aIsSubscribed )
    {
        programString = aProgramString;
        programNumber = aProgramNumber;
        virtualMajor = aVirtualMajor;
    ...
    public void setAllFields( String programString, int programNumber, int virtualMajor, int virtualMinor, String type, String name )
    {
    ...
    public boolean equals( Object obj )
    {
        ...
        if( programNumber != other.programNumber )
        {
            return false;
        }
        if( type == null )
        ...
        if( virtualMajor != other.virtualMajor )
        {
            return false;
        }
        if( virtualMinor != other.virtualMinor )
        {
            return false;
        }
        return true;
    ...
    {
        if( aVirtualChannelStatus != null && aVirtualChannelStatus.returnStatus > 0 )
        {
