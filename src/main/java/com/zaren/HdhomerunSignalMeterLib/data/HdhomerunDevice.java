...
public class HdhomerunDevice implements Serializable{
    ...
    private synchronized native int JNIsetChannelMap( long cPointer, String channelMap );

    private synchronized native int JNIsetTunerChannel( long cPointer, String channel );

    private synchronized native int JNIsetTunerVChannel( long cPointer, String channel );
    ...
    private synchronized native TunerStatus JNIgetTunerStatus( long cPointer );

    private synchronized native String JNIgetSupported( long cPointer );

    private synchronized native void JNIdestroy( long cPointer );

    private synchronized native String JNIgetChannelMap( long cPointer );

    private synchronized native int JNIupdateTunerStatus( long cPointer, TunerStatus tunerStatus );
